...
var MembershipService = class _MembershipService {
  ...
  initializeFreeMembership() {
    ...
    const config2 = MEMBERSHIP_CONFIG[level];
    const membership = {
      level,
      levelName: config2.name,
      levelIcon: config2.icon,
    ...
    console.log(`[MembershipService] \u521D\u59CB\u5316\u6703\u54E1: ${config2.icon} ${config2.name}`);
  ...
  async activateMembership(licenseKey, email) {
    ...
    return {
      success: true,
      message: `\u{1F389} ${config2.icon} ${config2.name} \u6FC0\u6D3B\u6210\u529F\uFF01\u6709\u6548\u671F\u81F3 ${expiresAt.toLocaleDateString()}`
    };
  }
  /**
   * 使用邀請碼
...
var LicenseClientService = class _LicenseClientService {
  constructor() {
    this.membershipService = inject2(MembershipService);
    this.toastService = inject2(ToastService);
    this.securityService = inject2(SecurityClientService);
    this.ngZone = inject2(NgZone);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-FLFTWIRB.js.map
