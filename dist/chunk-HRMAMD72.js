...
function WalletRechargeComponent_div_85_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 46);
  }
  if (rf & 2) {
...
function WalletRechargeComponent_div_85_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
...
function WalletRechargeComponent_div_85_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(15, WalletRechargeComponent_div_85_Conditional_15_Template, 1, 1, "img", 46)(16, WalletRechargeComponent_div_85_Conditional_16_Template, 3, 0, "div", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 48)(18, "div", 49);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(36, "div", 53)(37, "button", 54);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.qrCodeUrl() ? 15 : 16);
    \u0275\u0275advance(4);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WalletRechargeComponent, selectors: [["app-wallet-recharge"]], decls: 87, vars: 18, consts: [[1, "recharge-view"], [1, "view-header"], [1, "header-left"], [1, "back-btn", 3, "click"], [1, "icon"], [1, "current-balance"], [1, "label"], [1, "amount"], [1, "section"], [1, "package-grid"], [1, "package-item", 3, "selected", "recommended"], [1, "custom-amount"], [1, "input-group"], [1, "currency"], ["type", "number", "placeholder", "5 - 1000", "min", "5", "max", "1000", 3, "ngModelChange", "input", "ngModel"], [1, "hint"], [1, "payment-methods"], [1, "payment-method", 3, "click"], [1, "method-icon"], [1, "method-info"], [1, "method-name"], [1, "method-desc"], [1, "method-badge", "recommended"], [1, "section", "payment-summary"], [1, "summary-rows"], [1, "summary-row"], [1, "value"], ["class", "summary-row bonus", 4, "ngIf"], ["class", "summary-row", 4, "ngIf"], [1, "summary-row", "total"], [1, "action-bar"], [1, "confirm-btn", 3, "click", "disabled"], ["class", "modal-overlay", 4, "ngIf"], ["class", "loading-overlay", 4, "ngIf"], [1, "package-item", 3, "click"], [1, "package-amount"], [1, "package-bonus"], [1, "recommended-badge"], [1, "summary-row", "bonus"], [1, "modal-overlay"], [1, "modal", "usdt-modal"], [1, "modal-header"], [1, "close-btn", 3, "click"], [1, "modal-body"], [1, "usdt-info"], [1, "qr-code-container"], ["alt", "USDT Address QR Code", 1, "qr-code-img", 3, "src"], [1, "qr-loading"], [1, "address-box"], [1, "network-badge"], [1, "address"], [1, "copy-btn", 3, "click"], [1, "usdt-notes"], [1, "modal-footer"], [1, "primary-btn", 3, "click"], [1, "loading-overlay"], [1, "loading-spinner"]], template: function WalletRechargeComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(84);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(85, WalletRechargeComponent_div_85_Template, 39, 5, "div", 32)(86, WalletRechargeComponent_div_86_Template, 4, 0, "div", 33);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(12);
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;0109fa18ce9634627186f2402b736c56ee59292924988f0fe24fdeafc70af7ce;D:/tgkz2026/src/views/wallet-recharge.component.ts */\n.recharge-view {\n  min-height: 100vh;\n  background:\n    linear-gradient(\n      135deg,\n      #1a1a2e 0%,\n      #16213e 50%,\n      #0f3460 100%);\n  padding: 20px;\n  padding-bottom: 100px;\n  color: #fff;\n}\n.view-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 24px;\n}\n.header-left {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.back-btn {\n  width: 40px;\n  height: 40px;\n  border-radius: 12px;\n  background: rgba(255, 255, 255, 0.1);\n  border: none;\n  color: #fff;\n  font-size: 20px;\n  cursor: pointer;\n}\nh1 {\n  font-size: 24px;\n  font-weight: 600;\n  margin: 0;\n}\n.current-balance {\n  text-align: center;\n  padding: 20px;\n  background: rgba(255, 255, 255, 0.05);\n  border-radius: 16px;\n  margin-bottom: 24px;\n}\n.current-balance .label {\n  display: block;\n  font-size: 14px;\n  opacity: 0.7;\n  margin-bottom: 8px;\n}\n.current-balance .amount {\n  font-size: 32px;\n  font-weight: 700;\n  color: #667eea;\n}\n.section {\n  background: rgba(255, 255, 255, 0.05);\n  border-radius: 16px;\n  padding: 20px;\n  margin-bottom: 20px;\n}\n.section h2 {\n  font-size: 16px;\n  font-weight: 600;\n  margin: 0 0 16px 0;\n}\n.package-grid {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 12px;\n}\n.package-item {\n  position: relative;\n  padding: 20px 12px;\n  background: rgba(255, 255, 255, 0.05);\n  border: 2px solid transparent;\n  border-radius: 12px;\n  text-align: center;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.package-item:hover {\n  border-color: rgba(102, 126, 234, 0.5);\n}\n.package-item.selected {\n  border-color: #667eea;\n  background: rgba(102, 126, 234, 0.1);\n}\n.package-item.recommended {\n  border-color: rgba(245, 158, 11, 0.5);\n}\n.package-amount {\n  font-size: 20px;\n  font-weight: 700;\n  margin-bottom: 4px;\n}\n.package-bonus {\n  font-size: 12px;\n  color: #f59e0b;\n}\n.recommended-badge {\n  position: absolute;\n  top: -8px;\n  right: -8px;\n  background: #f59e0b;\n  color: #000;\n  font-size: 10px;\n  padding: 2px 8px;\n  border-radius: 10px;\n  font-weight: 600;\n}\n.custom-amount {\n  margin-top: 16px;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  flex-wrap: wrap;\n}\n.custom-amount .label {\n  font-size: 14px;\n  opacity: 0.7;\n}\n.input-group {\n  display: flex;\n  align-items: center;\n  background: rgba(255, 255, 255, 0.1);\n  border-radius: 8px;\n  padding: 0 12px;\n}\n.input-group .currency {\n  font-size: 16px;\n  opacity: 0.7;\n}\n.input-group input {\n  width: 100px;\n  padding: 10px 8px;\n  background: transparent;\n  border: none;\n  color: #fff;\n  font-size: 16px;\n}\n.custom-amount .hint {\n  font-size: 12px;\n  opacity: 0.5;\n}\n.payment-methods {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.payment-method {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px;\n  background: rgba(255, 255, 255, 0.05);\n  border: 2px solid transparent;\n  border-radius: 12px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.payment-method:hover {\n  border-color: rgba(255, 255, 255, 0.2);\n}\n.payment-method.selected {\n  border-color: #667eea;\n  background: rgba(102, 126, 234, 0.1);\n}\n.method-icon {\n  font-size: 24px;\n}\n.method-info {\n  flex: 1;\n}\n.method-name {\n  font-size: 14px;\n  font-weight: 500;\n}\n.method-desc {\n  font-size: 12px;\n  opacity: 0.6;\n}\n.method-badge.recommended {\n  background:\n    linear-gradient(\n      135deg,\n      #667eea,\n      #764ba2);\n  color: #fff;\n  font-size: 11px;\n  padding: 4px 10px;\n  border-radius: 10px;\n}\n.payment-summary .summary-rows {\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.summary-row {\n  display: flex;\n  justify-content: space-between;\n  font-size: 14px;\n}\n.summary-row .label {\n  opacity: 0.7;\n}\n.summary-row.bonus .value {\n  color: #f59e0b;\n}\n.summary-row.total {\n  padding-top: 12px;\n  border-top: 1px solid rgba(255, 255, 255, 0.1);\n  font-size: 18px;\n  font-weight: 600;\n}\n.summary-row.total .value {\n  color: #22c55e;\n}\n.action-bar {\n  position: fixed;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  padding: 16px 20px;\n  background: rgba(26, 26, 46, 0.95);\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n}\n.confirm-btn {\n  width: 100%;\n  padding: 16px;\n  border-radius: 12px;\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  border: none;\n  color: #fff;\n  font-size: 16px;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.confirm-btn:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.confirm-btn:not(:disabled):hover {\n  transform: translateY(-2px);\n  box-shadow: 0 8px 20px rgba(102, 126, 234, 0.4);\n}\n.modal-overlay {\n  position: fixed;\n  inset: 0;\n  background: rgba(0, 0, 0, 0.8);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 100;\n  padding: 20px;\n}\n.modal {\n  background: #1a1a2e;\n  border-radius: 20px;\n  max-width: 400px;\n  width: 100%;\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 20px;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n}\n.modal-header h3 {\n  margin: 0;\n  font-size: 18px;\n}\n.close-btn {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  background: rgba(255, 255, 255, 0.1);\n  border: none;\n  color: #fff;\n  font-size: 20px;\n  cursor: pointer;\n}\n.modal-body {\n  padding: 20px;\n}\n.usdt-info p {\n  margin-bottom: 16px;\n}\n.qr-code-container {\n  width: 180px;\n  height: 180px;\n  margin: 0 auto 20px;\n  background: #fff;\n  border-radius: 12px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  overflow: hidden;\n}\n.qr-code-img {\n  width: 160px;\n  height: 160px;\n  object-fit: contain;\n}\n.qr-loading {\n  color: #666;\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #333;\n}\n.address-box {\n  background: rgba(255, 255, 255, 0.05);\n  border-radius: 12px;\n  padding: 16px;\n  margin-bottom: 20px;\n}\n.network-badge {\n  display: inline-block;\n  background: #22c55e;\n  color: #fff;\n  font-size: 11px;\n  padding: 4px 10px;\n  border-radius: 10px;\n  margin-bottom: 8px;\n}\n.address {\n  font-family: monospace;\n  font-size: 12px;\n  word-break: break-all;\n  margin-bottom: 12px;\n  opacity: 0.9;\n}\n.copy-btn {\n  width: 100%;\n  padding: 10px;\n  background: rgba(102, 126, 234, 0.2);\n  border: 1px solid #667eea;\n  color: #667eea;\n  border-radius: 8px;\n  cursor: pointer;\n}\n.usdt-notes {\n  font-size: 13px;\n  opacity: 0.7;\n}\n.usdt-notes ul {\n  margin: 8px 0 0 16px;\n  padding: 0;\n}\n.usdt-notes li {\n  margin-bottom: 4px;\n}\n.modal-footer {\n  padding: 20px;\n  border-top: 1px solid rgba(255, 255, 255, 0.1);\n}\n.primary-btn {\n  width: 100%;\n  padding: 14px;\n  background:\n    linear-gradient(\n      135deg,\n      #667eea 0%,\n      #764ba2 100%);\n  border: none;\n  border-radius: 10px;\n  color: #fff;\n  font-size: 15px;\n  font-weight: 600;\n  cursor: pointer;\n}\n.loading-overlay {\n  position: fixed;\n  inset: 0;\n  background: rgba(0, 0, 0, 0.7);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 16px;\n  z-index: 200;\n}\n.loading-spinner {\n  width: 40px;\n  height: 40px;\n  border: 3px solid rgba(255, 255, 255, 0.2);\n  border-top-color: #667eea;\n  border-radius: 50%;\n  animation: spin 1s linear infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n/*# sourceMappingURL=wallet-recharge.component.css.map */\n"] }]
  }], () => [{ type: WalletService }, { type: Router }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WalletRechargeComponent, { className: "WalletRechargeComponent", filePath: "src/views/wallet-recharge.component.ts", lineNumber: 684 });
})();

export {
  WalletRechargeComponent
};
//# sourceMappingURL=chunk-HRMAMD72.js.map
