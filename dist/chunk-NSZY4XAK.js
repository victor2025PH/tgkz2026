...
var RegisterComponent = class _RegisterComponent {
  constructor() {
    ...
    this.canSubmit = computed(() => this.email && this.password && this.password === this.confirmPassword && this.agreeTerms && this.passwordStrength() >= 2 && !this.isLoading(), ...ngDevMode ? [{ debugName: "canSubmit" }] : []);
...
//# sourceMappingURL=chunk-NSZY4XAK.js.map
