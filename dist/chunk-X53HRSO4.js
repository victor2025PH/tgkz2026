...
var AuthService = class _AuthService {
  constructor() {
    ...
    this.subscriptionTier = computed(() => this._user()?.subscription_tier || this._user()?.membershipLevel || "free", ...ngDevMode ? [{ debugName: "subscriptionTier" }] : []);
    this.maxAccounts = computed(() => this._user()?.max_accounts || 3, ...ngDevMode ? [{ debugName: "maxAccounts" }] : []);
    this.isPro = computed(() => ["pro", "enterprise", "gold", "diamond", "star", "king"].includes(this.subscriptionTier()), ...ngDevMode ? [{ debugName: "isPro" }] : []);
...
//# sourceMappingURL=chunk-X53HRSO4.js.map
