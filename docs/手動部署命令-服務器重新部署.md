...
> ⚠️ **本文檔所述服務器（165.154.210.154）已停用（2026-07-20），僅作歷史操作流程參考，
> 文中命令範例不可直接執行。啟用新服務器時，請按下方流程改用新的 IP/憑證，憑證請走
> 密碼管理工具或環境變量，不要再寫回本文檔或任何代碼文件。**
>
> **更新日期**: 2026-02-05  
> **服務器**: 165.154.210.154（已停用）  
> **用戶**: ubuntu
...
```bash
# 1. SSH 登錄（密碼請走密碼管理工具/環境變量獲取，不要寫在文檔或代碼裡）
