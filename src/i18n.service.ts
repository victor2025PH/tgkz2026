  ...
  private getFlatTranslation(key: string, locale: SupportedLocale): string | undefined {
    const flatTranslations: Record<SupportedLocale, Record<string, string>> = {
      ...
      'zh-CN': {
        ...
        accountStatus: '账户状态',
        activeListenerAccounts: '活跃监听账户',
        noActiveListeners: '无活跃监听账户',
      ...
      'zh-TW': {
        ...
        accountStatus: '帳號狀態',
        activeListenerAccounts: '活躍監聽帳號',
        noActiveListeners: '無活躍監聽帳號',
